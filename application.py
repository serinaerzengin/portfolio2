...
def SRold_client(clientSocket, server_Addr, test, file_sent, window_size,rtt):
    # data list from file
    raw_datalist = file_splitting(file_sent) # array contains raw data
...
=======
>>>>>>> df6c1ee43396cb32cc1729d7b9716d6a154ab417
    clientSocket.settimeout(rtt)
    ...
    while base < len(raw_datalist):
        ...
        while next_to_send < base + WINDOW_SIZE and next_to_send < len(formatted_packets_list): 
            ...
            # send all packets in this window
<<<<<<< HEAD
            else: #packet["seq_num"] >= next_in_wd: 
=======
            else:
>>>>>>> df6c1ee43396cb32cc1729d7b9716d6a154ab417
                # create packet
...
def SRold_server(serverSocket, file_name, test):
    data_list = []
    empty_data = b''
    total_received = 0
    last_ack_sent = -1
